...
import static com.liferay.apio.architect.sample.internal.form.BlogPostingCommentUpdaterForm.buildForm;
	...
	public void test() {
		assertThat(
			...
			isAFormWithConditions(
				builder -> builder.whereString(
					"text", isReturnedIn(BlogPostingCommentUpdaterForm::getText)
				).build()));
	}

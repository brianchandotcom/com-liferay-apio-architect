...
/**
 * Defines a {@code java.util.function.Function} that takes three input
...
public interface TriFunction<A, B, C, R> {
	...
	/**
	 * Returns the {@code TriFunction} that first executes the current
	 * {@code TriFunction} instance's {@code apply} method, then uses the

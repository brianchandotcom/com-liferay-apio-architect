...
/**
 * Function {@link java.util.function.Function} with three input parameters.
...
public interface TriFunction<A, B, C, R> {
	 ...
	 *
	 * @param  afterFunction the {@code TriFunction} to execute after this instance
	 * @return another {@code TriFunction} that executes both inputs

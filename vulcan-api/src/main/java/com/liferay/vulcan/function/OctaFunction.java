...
/**
 * Function {@link java.util.function.Function} with eight input parameters.
...
public interface OctaFunction<A, B, C, D, E, F, G, H, R> {
	 ...
	 *
	 * @param  afterFunction the {@code OctaFunction} to execute after this instance
	 * @return another {@code OctaFunction} that executes both inputs

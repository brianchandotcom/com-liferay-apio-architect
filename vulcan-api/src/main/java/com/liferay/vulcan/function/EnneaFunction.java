...
/**
 * Function {@link java.util.function.Function} with nine input parameters.
...
public interface EnneaFunction<A, B, C, D, E, F, G, H, I, R> {
	 ...
	 *
	 * @param  afterFunction the {@code EnneaFunction} to execute after this instance
	 * @return another {@code EnneaFunction} that executes both inputs

...
/**
 * Function {@link java.util.function.Function} with six input parameters.
...
public interface HexaFunction<A, B, C, D, E, F, R> {
	 ...
	 *
	 * @param  afterFunction the {@code HexaFunction} to execute after this instance
	 * @return another {@code HexaFunction} that executes both inputs

...
/**
 * Function {@link java.util.function.Function} with five input parameters.
...
public interface PentaFunction<A, B, C, D, E, R> {
	 ...
	 *
	 * @param  afterFunction the {@code PentaFunction} to execute after this instance
	 * @return another {@code PentaFunction} that executes both inputs

...
public class CustomOperationsEndpoint<T, S, R> {
	...
	public void addDeleteCollection(@PathParam("operation") String operation) {
		_getCollectionSingleModelTry(operation, Method.DELETE, null);
	}
	...
	public void addDeleteItem(
		...
		_getItemSingleModelTry(operation, Method.DELETE, id, null);
	}
	...
	public Try<SingleModel<R>> addGetCollection(
		...
		return _getCollectionSingleModelTry(operation, Method.GET, null);
	}
	...
	public Try<SingleModel<R>> addGetItem(
		...
		return _getItemSingleModelTry(operation, Method.GET, id, null);
	}
	...
	public Try<SingleModel<R>> addPostCollection(
		...
		return _getCollectionSingleModelTry(operation, Method.POST, body);
	}
	...
	public Try<SingleModel<R>> addPostItem(
		...
		return _getItemSingleModelTry(operation, Method.POST, id, body);
	}
	...
	public Try<SingleModel<R>> addPutCollection(
		...
		return _getCollectionSingleModelTry(operation, Method.PUT, body);
	}
	...
	public Try<SingleModel<R>> addPutItem(
		...
		return _getItemSingleModelTry(operation, Method.PUT, id, body);
	}

	@SuppressWarnings("unchecked")
	private Try<SingleModel<R>> _getCollectionSingleModelTry(
		String operation, Method method, Body body) {
	...
	private Try<SingleModel<R>> _getItemSingleModelTry(
		String operation, Method method, String id, Body body) {

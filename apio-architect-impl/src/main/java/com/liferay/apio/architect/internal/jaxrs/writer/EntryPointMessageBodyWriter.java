...
import com.liferay.apio.architect.internal.wiring.osgi.manager.message.json.EntryPointMessageMapperManager;
...
@Component(
	property = {
		...
		"osgi.jaxrs.extension=true", "osgi.jaxrs.name=Writer.EntryPoint"
	},
